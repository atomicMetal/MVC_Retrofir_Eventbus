...
public final class StorageUtils {
     ...
     * cases (if SD card is unmounted and {@link Context#getCacheDir() Context.getCacheDir()}
     * returns null).
     */
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (preferExternal && MEDIA_MOUNTED.equals(
                externalStorageState) && hasExternalStoragePermission(context)) {
     ...
     * Cache directory will be created on SD card <i>
     * ("/Android/data/[app_package_name]/cache/uil-images")
     * </i> if card is mounted and app has appropriate permission. Else - Android defines cache
