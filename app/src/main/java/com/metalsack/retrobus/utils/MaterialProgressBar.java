...
public class MaterialProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColors[0] = a.getColor(
                R.styleable.MaterialProgressBar_colorscheme, Color.WHITE);
        ...
        //mCircleBackgroundEnabled=false;
    ...
    public void setBackgroundColor(int colorRes1) {
        if (getBackground() instanceof ShapeDrawable) {
            final Resources res = getResources();
            ((ShapeDrawable) getBackground()).getPaint().setColor(colorRes1);
        }
    }
