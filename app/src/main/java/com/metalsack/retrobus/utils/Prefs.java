...
public class Prefs {
    ...
    public static int getInt(final String key) {
        if (mDefIntValue == null) {
            ...
            throw new NullPointerException(
                    "You did not set a default value, please refer to documentation");
        }
    ...
    public static double getDouble(final String key, final double defValue) {
        return Double.longBitsToDouble(
                getPreferences().getLong(key, Double.doubleToLongBits(defValue)));
    }

    /**
     * DEFAULT IS -1 Returns the double that has been saved as a long raw bits value in the long
     * preferences.
     *
     * @param key The name of the preference to retrieve.
     * @return Returns the preference value if it exists, or defValue.  Throws ClassCastException if
    ...
    public static double getDouble(final String key) {
        return Double.longBitsToDouble(
                getPreferences().getLong(key, Double.doubleToLongBits(mDefIntValue)));
    }
    ...
    /**
     * if default value was set that value is set as default
     *
     * @param key The name of the preference to retrieve.
     * @return Returns the preference value if it exists, or defValue.  Throws ClassCastException if
     * there is a preference with this name that is not a float.
    ...
    public static float getFloat(final String key) {
        if (mDefIntValue == null) {
            Log.e("Null Val", "Default value not set");
            throw new NullPointerException(
                    "You did not set a default int value, please refer to documentation");
        }
    ...
    /**
     * @return the for chaining. The changes have already been committed/applied through the
    ...
    public final static class Builder {
        ...
        /**
         * Set the filename of the shared preference instance usually this is the applications
         * packagename but for migration purposes or customization.
         *
        ...
        public Builder setMode(final int mode) {
            if (mode == ContextWrapper.MODE_PRIVATE ||
                ...
                throw new RuntimeException(
                        "The mode in the sharedpreference can only be set too ContextWrapper" +
                        ".MODE_PRIVATE, ContextWrapper.MODE_WORLD_READABLE, " +
                        "ContextWrapper.MODE_WORLD_WRITEABLE or ContextWrapper" +
                        ".MODE_MULTI_PROCESS");
            }
